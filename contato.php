<link rel="stylesheet" href="./css/contato_css.css" type="text/css">
<script type="text/javascript" src="./js/contato_js.js"></script>
<div class="container">
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2 text-center">
            ...
            <form id="form_contato">
                ...
                <div class="form-group">
                    ...
                    <textarea oninput="Contato_refreshCaracters()" class="form-control" maxlength="200" name="mensagem" id="mensagem" rows="5"></textarea>
                </div>
                <div id="contador">200 Restantes</div>
                <button type="button" onclick="Contato_addMensagem()" class="btn btn-primary btn-xl" id="enviar">Enviar</button>
            </form>
