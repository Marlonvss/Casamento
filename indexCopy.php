...
<div class="container" id="confirmarPresenca">
    ...
    <form method="POST" action="convidado.php">
        ...
        <input type="text" name="convite" id="convite" required oninvalid="setCustomValidity('Fala ae Negou! pow, 20 anos de curso! Coloca o nro do convite aí viril, isso padrao!')" onchange="try{setCustomValidity('')}catch(e){}"><br>
